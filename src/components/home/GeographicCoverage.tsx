  ...
  const expansionPlans = [
    {
      ...
      description: 'Expanding to major cities in Northern and Eastern provinces'
    },
    {
      phase: 'Phase 2',
      timeline: '2024 Q3-Q4',
      regions: ['Rural Areas', 'Mining Communities'],
      description: 'Reaching rural communities and mining areas across Sierra Leone'
    },
    {
      phase: 'Phase 3',
      timeline: '2025',
      regions: ['Guinea', 'Liberia'],
      description: 'Cross-border expansion to neighboring West African countries'
    }
  ];
      ...
      <div className="container-max">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-heading font-bold text-charcoal mb-6">
            Connecting <span className="text-gradient">All of Sierra Leone</span>
          </h2>
          <p className="text-xl text-medium-gray max-w-3xl mx-auto">
            From Freetown to the provinces, we're building a network that reaches every community
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-gradient-to-br from-green-50 to-orange-50 rounded-3xl p-8 h-96 flex items-center justify-center">
              <div className="relative w-full h-full">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    <svg width="300" height="200" viewBox="0 0 300 200" className="text-green-800">
                      <path 
                    ...
                    <div className="absolute top-8 left-16">
                      ...
                      <span className="text-xs font-semibold text-charcoal ml-2">Freetown</span>
                    </div>
                    <div className="absolute top-20 right-20">
                      <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                      <span className="text-xs font-semibold text-charcoal ml-2">Bo</span>
                    </div>
                    <div className="absolute bottom-16 right-16">
                      <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                      <span className="text-xs font-semibold text-charcoal ml-2">Kenema</span>
                    </div>
                    <div className="absolute top-12 left-1/2">
                      <div className="w-3 h-3 bg-orange-500 rounded-full"></div>
                      <span className="text-xs font-semibold text-charcoal ml-2">Makeni</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4">
            {coverageAreas.map((area, index) => (
              <div key={index} className="bg-light-gray rounded-2xl p-6 flex items-center justify-between">
          ...
          <div className="bg-light-gray rounded-3xl p-8 md:p-12">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-medium-gray mb-8 leading-relaxed">
                We're committed to bringing fast, reliable delivery to every corner of Sierra Leone. 
                Whether you're in the heart of Freetown or a remote village, Gladdy will reach you.
              </p>
